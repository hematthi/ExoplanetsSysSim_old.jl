...
# Transformed:
#hparams_best = [1., 0.3, 1., 1.5, 1.2, 1.8, 3., 0.03, 60., 1., 0.15, 0.1]
#prior_bounds = [(0.1, 0.7), (0., 2.), (0., 2.2), (-0.8, 0.8), (-2., 0.), (-6., -2.), (0., 0.04), (0., 90.), (0., 3.), (0.15, 0.45), (0.1, 0.3)]
...
# Transformed:
#hparams_best = [1., 0.3, 1., 1.5, 0.5, 0.8, 2., 0.03, 60., 1., 0.1]
#prior_bounds = [(0., 0.6), (0., 2.), (0., 2.2), (-0.9, 0.5), (-2., 0.), (-6., -3.), (0., 0.05), (0., 90.), (0., 3.), (0.05, 0.3)]
...
#prior_bounds = [(0., 0.2), (0.6, 1.4), (-0.5, -0.1), (-1.5, 0.), (-6., -3.5), (0., 0.04), (0., 90.), (0., 1.5)]



dims = 11
GP_model = train_GP_emulator(; dims=dims, data_path=data_path, n_train=2000, n_cv=2000, mean_f=50., kernel=kernel_SE_ndims, hparams_best=hparams_best, optimize_hparams=false, make_plots=false)
